; (function (undefined) {
    ...
    var yui = {
        ...
        getNdayAgo: function (gap) {
            var date1 = new Date();
            var date = new Date(date1);
            date.setDate(date1.getDate() + gap);
        ...
        layer_closeNoCloseParent: function () {
            var index = parent.layer.getFrameIndex(window.name);
            parent.layer.close(index);
        },
        //bootstrap table
        ...
        tableAll: function (id, url, obj, method, key, singleSelect, qParams, sortName, sortOrder, isShowDate) {
            if (typeof singleSelect === "undefined") {
                singleSelect = true;
            }
            if (typeof isShowDate === "undefined") {
        ...
        tableStockNumber: function (id, url, obj, method, key, singleSelect, qParams, sortName, sortOrder, isShowDate) {
            if (typeof singleSelect === "undefined") {
                singleSelect = true;
            }
            if (typeof isShowDate === "undefined") {
            ...
            $("#" + id).bootstrapTable({
                ...
                queryParams: function (params) {
                    ...
                    if (isShowDate) {
                        temp.datemin = _self.$refs.datemin.value;
                        temp.datemax = _self.$refs.datemax.value;
                        temp.StockNumber = _self.$refs.StockNumber.value;
                    }
                    return yui.extend(temp, qParams);
                    //return $.extend(temp, qParams);
                },
    ...
    Vue.prototype.getYesterday = function () {
        return yui.getYesterday();
    };
    ...
    Vue.prototype.getLastYearMonthLast = function () {
        return yui.getLastYearMonthLast();
    };
    Vue.prototype.getNdayAgo = function (gap) {
        return yui.getNdayAgo(gap);
    };
