...
namespace PF.NetCoreApp.Extensions
{
            ...
            return app.UseExceptionHandler((err) =>
            {
                err.Run(async context =>
                {
                    ...
                    if (exception is Microsoft.AspNetCore.Http.BadHttpRequestException badHttpRequestException)
                    {
                        ...
                        problemDetails.Status = (int)typeof(Microsoft.AspNetCore.Http.BadHttpRequestException).GetProperty("StatusCode",
